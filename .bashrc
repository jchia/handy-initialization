...
if [ "$color_prompt" = yes ]; then
    PS1="$titlebar$grey\$(date +%H:%M) $cyan_bold\W$yellow\$(show_git_branch)$green\$$grey "
else
    PS1="$titlebar\$(date +%H:%M) \W\$(show_git_branch)\$ "
fi
unset color_prompt titlebar grey cyan_bold yellow green 
